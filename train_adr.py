...
from model import make_model_adr
from solver import make_optimizer
from solver.scheduler_factory import create_scheduler
from loss import make_loss
# from processor_prior import do_train
from processor_adr.processor import do_train
import random
import torch
import numpy as np
import os
...
if __name__ == '__main__':
    ...
    model = make_model_adr(cfg, num_class=num_classes, camera_num=camera_num, view_num=view_num)
